...
**КУРСЫ И ТРЕНИНГИ**
 1. ООО Нетология: 
   - программирование, курс "Python-разработчик" Диплом Python-разработка
   - программа "Визуализация данных: от скучных графиков до интерактивных дашбордов"  Сертификат -Визуализация данных
   - программа "Основы SQL" Свидетельство -Основы SQL
   - 
**ОБО МНЕ**
